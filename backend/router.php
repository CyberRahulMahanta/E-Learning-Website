...
$routes = [
    ...
    ['methods' => ['POST'], 'pattern' => '#^courses/(?P<id>[^/]+)/modules/reorder$#', 'file' => __DIR__ . '/api/learning/module_reorder.php'],
    ...
    ['methods' => ['GET'], 'pattern' => '#^courses/(?P<id>[^/]+)/assignment-submissions$#', 'file' => __DIR__ . '/api/assignments/instructor_submissions.php'],
    ...
    ['methods' => ['POST'], 'pattern' => '#^modules/(?P<id>[^/]+)/lessons/reorder$#', 'file' => __DIR__ . '/api/learning/lesson_reorder.php'],
    ...
    ['methods' => ['GET'], 'pattern' => '#^lessons/(?P<id>[^/]+)/resources$#', 'file' => __DIR__ . '/api/learning/resources_list.php'],
    ['methods' => ['POST'], 'pattern' => '#^lessons/(?P<id>[^/]+)/resources$#', 'file' => __DIR__ . '/api/learning/resource_add.php'],
    ['methods' => ['POST'], 'pattern' => '#^lessons/(?P<id>[^/]+)/progress$#', 'file' => __DIR__ . '/api/progress/update.php'],
    ['methods' => ['PUT', 'PATCH', 'POST'], 'pattern' => '#^resources/(?P<id>[^/]+)$#', 'file' => __DIR__ . '/api/learning/resource_edit.php'],
    ['methods' => ['DELETE'], 'pattern' => '#^resources/(?P<id>[^/]+)$#', 'file' => __DIR__ . '/api/learning/resource_delete.php'],
    ['methods' => ['PUT', 'PATCH', 'POST'], 'pattern' => '#^quizzes/(?P<id>[^/]+)$#', 'file' => __DIR__ . '/api/quizzes/edit.php'],
    ['methods' => ['DELETE'], 'pattern' => '#^quizzes/(?P<id>[^/]+)$#', 'file' => __DIR__ . '/api/quizzes/delete.php'],
    ['methods' => ['POST'], 'pattern' => '#^quizzes/(?P<id>[^/]+)/attempt$#', 'file' => __DIR__ . '/api/quizzes/attempt.php'],
    ['methods' => ['PUT', 'PATCH', 'POST'], 'pattern' => '#^assignments/(?P<id>[^/]+)$#', 'file' => __DIR__ . '/api/assignments/edit.php'],
    ['methods' => ['DELETE'], 'pattern' => '#^assignments/(?P<id>[^/]+)$#', 'file' => __DIR__ . '/api/assignments/delete.php'],
    ['methods' => ['POST'], 'pattern' => '#^assignments/(?P<id>[^/]+)/submit$#', 'file' => __DIR__ . '/api/assignments/submit.php'],
    ['methods' => ['PUT', 'PATCH', 'POST'], 'pattern' => '#^assignment-submissions/(?P<id>[^/]+)/review$#', 'file' => __DIR__ . '/api/assignments/review_submission.php'],
    ...
    ['methods' => ['GET'], 'pattern' => '#^certificates/verify/(?P<code>[^/]+)$#', 'file' => __DIR__ . '/api/certificates/verify.php'],
